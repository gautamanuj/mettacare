  ...
  <footer className="bg-navy text-gold py-8 px-4 mt-12">
    <div className="max-w-4xl mx-auto flex flex-col items-center">
      ...
      <div className="italic text-base mb-6 text-center">
        We acknowledge the Traditional Custodians of the land on which we work and live, the Darug people, and pay our respects to Elders past and present. We extend that respect to all Aboriginal and Torres Strait Islander peoples today.
      </div>
      {/* Link Row */}
